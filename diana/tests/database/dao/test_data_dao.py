...
test_cases = [
    ...
    # input 2: no port
    {"time_range": [1658826729, 1658913129], "host_list": [{"host_id": 1, "host_ip": "172.168.128.164"}]},
    # input 3: empty host list
    {"time_range": [1658826729, 1658913129], "host_list": []},
    # input 4: multi-host
    {
        "time_range": [1658826729, 1658913129],
        "host_list": [
            {"host_id": 1, "host_ip": "172.168.128.164", "instance_port": 9100},
            {"host_id": 1, "host_ip": "172.168.128.164", "instance_port": 8080},
...
metric_list_ret = [
    ...
    [
        {
            'metric': {'instance': '172.168.128.164:9100', 'job': 'prometheus', 'quantile': '0'},
            'value': [1658975590.796, '0.000032261'],
        },
        {
            'metric': {
    ...
    [
        {
            'metric': {
                '__name__': 'go_gc_duration_seconds1',
                'instance': '172.168.128.164:8080',
                'job': 'prometheus',
                'quantile': '0',
            },
            'value': [1658975590.796, '0.000032261'],
        ...
        {
            'metric': {
                '__name__': 'promhttp_metric_handler_requests_total1',
                'code': '503',
                'instance': '172.168.128.164:8080',
                'job': 'prometheus',
            },
        ...
        {
            'metric': {'__name__': 'up1', 'instance': '172.168.128.164:8080', 'job': 'prometheus'},
            'value': [1658975590.796, '1'],
        },
    ],
    ...
    [
        {
            'metric': {
                '__name__': 'go_gc_duration_seconds2',
                'instance': '172.168.128.165:9100',
                'job': 'prometheus',
                'quantile': '0',
            },
            'value': [1658975590.796, '0.000032261'],
        ...
        {
            'metric': {
                '__name__': 'promhttp_metric_handler_requests_total2',
                'code': '503',
                'instance': '172.168.128.165:9100',
                'job': 'prometheus',
            },
        ...
        {
            'metric': {'__name__': 'up2', 'instance': '172.168.128.165:9100', 'job': 'prometheus'},
            'value': [1658975590.796, '1'],
        },
    ],
]
...
raw_data_ret = [
    ...
    [
        ...
        [
            {
                'metric': {
                    '__name__': 'promhttp_metric_handler_requests_total5',
                    'code': '200',
                    'instance': '172.168.128.165:9100',
                    'job': 'prometheus',
                },
...
query_ret = [
    # ret 1: normal
    {
        1: {
            ...
            '{instance="172.168.128.164:9100",quantile="0"}': [
                [1658913069, '0.00002582'],
                [1658913084, '0.00002582'],
                [1658913099, '0.00002582'],
                [1658913114, '0.00002738'],
            ...
            '{code="503",instance="172.168.128.164:9100"}': [
                [1658913069, '28872'],
                [1658913084, '28873'],
                [1658913099, '28874'],
                [1658913114, '28875'],
            ...
            'up{instance="172.168.128.164:9100"}': [
                [1658913069, '1'],
                [1658913084, '1'],
                [1658913099, '1'],
                [1658913114, '1'],
    ...
    # ret 4: multi-host
    {
        1: {
            ...
            '{instance="172.168.128.164:8080",quantile="0"}': [
                [1658913069, '0.00002582'],
                [1658913084, '0.00002582'],
                [1658913099, '0.00002582'],
                [1658913114, '0.00002738'],
        ...
        2: {
            ...
            '{instance="172.168.128.165:9100",quantile="0"}': [
                [1658913069, '0.00002582'],
                [1658913084, '0.00002582'],
                [1658913099, '0.00002582'],
                [1658913114, '0.00002738'],
...
class DataDaoTestcase(unittest.TestCase):
    ...
    def test_query_data_should_return_succeed_when_input_is_normal(self):
        ...
        ret, data_list = self.dao.query_data(test_cases[0]["time_range"], test_cases[0]["host_list"])
    ...
    def test_query_data_should_return_succeed_when_host_without_port(self):
        ...
        ret, data_list = self.dao.query_data(test_cases[1]["time_range"], test_cases[1]["host_list"])
        self.assertEqual(SUCCEED, ret)
        self.assertDictEqual(data_list, query_ret[0])

    def test_query_data_should_return_error_when_host_list_empty(self):
        ret, data_list = self.dao.query_data(test_cases[2]["time_range"], test_cases[2]["host_list"])
    ...
    def test_query_data_should_return_id_key_when_mutihost(self):
        self.dao._prom.custom_query = MagicMock(
            side_effect=[metric_list_ret[0], metric_list_ret[2], metric_list_ret[3]]
        )
        self.dao._prom.custom_query_range = MagicMock(side_effect=raw_data_ret[3])

        ret, data_list = self.dao.query_data(test_cases[3]["time_range"], test_cases[3]["host_list"])
        self.assertEqual(PARTIAL_SUCCEED, ret)
