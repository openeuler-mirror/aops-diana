...
class MysqlNetworkDiagnoseTestCase(unittest.TestCase):
    def test_somoke(self):
        model_info = {
            "intelligent-for-tpcc": {"model_name": "intelligent-for-tpcc", "algo_id": "", "algo_name": "Intelligent"}
        }
        detail = {"multicheck": {"host1": "intelligent-for-tpcc", "host2": "intelligent-for-tpcc"}}
        data = {
            1: {
                "metric1": {
                    "label1": [
